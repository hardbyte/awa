...
1. Read [Deployment](../deployment/index.md) for process topology, graceful shutdown, migration ordering, and container images.
2. Use [Managed Postgres](../deploying-on-managed-postgres/index.md) for hosted-service constraints and tuning.
3. Apply the role split in [Security](../security/index.md).
4. Import the [Grafana dashboards and alerts](../grafana/index.md), or query the same health surfaces with the CLI.
5. Keep [Troubleshooting](../troubleshooting/index.md) with your runbooks.
