...
async def main() -> int:
    ...
    try:
        ...
        # shutdown() drains workers but deliberately leaves the pool open.
        # Finish both lifecycles before asyncio and CPython tear down.
        try:
...
if result == 0:
    print(f"FORWARD-{os.environ['COMPAT_VERSION']} PASS")
sys.exit(result)
