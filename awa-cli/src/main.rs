...
/// Turn a migration description into one safe filename component.
///
/// Descriptions are prose: they contain spaces, punctuation, and — for v017 —
/// `/`. Anything outside `[A-Za-z0-9._-]` becomes `_` so the result can never
/// escape the target directory or name a file the OS rejects.
