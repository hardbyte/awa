-- v041 (#371): append-only ring-rotation ledgers and terminal-rollup deltas.
--
...
-- seeded from them. A pre-v041 binary reading a stale frozen cursor would
...
-- run a mixed fleet of pre-/post-v041 binaries against one database. See
...
VALUES (41, 'Append-only ring-rotation ledgers and terminal-rollup deltas (#371)')
