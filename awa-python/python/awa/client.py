...
class AsyncClient:
    ...
    # --- Dead Letter Queue -------------------------------------------------
    #
    # DLQ rows live in `awa.jobs_dlq`, outside the hot claim path. These
    # methods expose the operator-level admin surface: inspect, retry, move
    # failed jobs in, and purge. See `awa-model/src/dlq.rs` for semantics.
    ...
    async def bulk_retry_from_dlq(
        ...
        *,
        ...
        return await self._raw.bulk_retry_from_dlq(kind=kind, queue=queue, tag=tag)
    ...
    async def purge_dlq(
        ...
        *,
        ...
        return await self._raw.purge_dlq(kind=kind, queue=queue, tag=tag)
...
class Client:
    ...
    def bulk_retry_from_dlq(
        ...
        *,
        ...
        return self._raw.bulk_retry_from_dlq_sync(kind=kind, queue=queue, tag=tag)
    ...
    def purge_dlq(
        ...
        *,
        ...
        """Bulk-delete DLQ rows matching the filter."""
        return self._raw.purge_dlq_sync(kind=kind, queue=queue, tag=tag)
