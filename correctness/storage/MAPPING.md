...
| `RescueToReady(j)` | `rescue_stale_heartbeats` (`queue_storage.rs:10618`) / `rescue_expired_deadlines` (`:10756`) in maintenance | `DELETE FROM leases ... RETURNING ...; INSERT INTO ready_entries ...` |
