...
[ADR-042](../adr/042-caller-owned-finalization-transactions.md) and [ADR-043](../adr/043-postgresql-capability-functions.md) describe accepted/proposed boundaries for a narrower application finalizer and capability-specific runtime roles planned for 0.7. They are not the current 0.6 privilege model.
