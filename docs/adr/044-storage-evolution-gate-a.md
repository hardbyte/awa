...
**Gate A** scope decision defined in the [0.7 roadmap §5](../0.7-roadmap.md)
...
- [0.7 roadmap](../0.7-roadmap.md) — D1, §5 experiments, Gate A rule
- [#169 spike](../archive/0.6-storage-design/issue-169-storage-spike.md) — original degradation evidence
