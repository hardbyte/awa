...
Accepted. The [migration-authoring checklist](../development.md#authoring-schema-migrations) and automated mixed-version rehearsal tracked by [#427](https://github.com/hardbyte/awa/issues/427) carry this decision into practice.
