...
Start from the repository's [`AGENTS.md`](https://github.com/hardbyte/awa/blob/main/AGENTS.md) when working with a coding agent; it contains the always-on validation and Agent Skills rules.
