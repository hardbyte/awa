...
Use `--database-url` or `DATABASE_URL`. Commands that mutate state can require stronger privileges than read-only inspection; use the [security guide](../security.md) to split migration, runtime, maintenance, and observer roles.
